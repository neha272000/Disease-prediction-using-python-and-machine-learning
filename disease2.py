...
def randomforest():
    ...
    psymptoms = [Symptom1.get(),Symptom2.get(),Symptom3.get(),Symptom4.get(),Symptom5.get()] #retrieving the symptoms using get function
...
"""
lb2=Label(win,font=("arial",13,"bold"),text="HIRE PREDICTOR SYSTEM",height=3,width=140,bg="black",fg="yellow") #if ANCHOR direction not mentioned then by default test is in centre
lb2.grid(row=1)

f1=Frame(win,width=1363,height=400,bg="blue",highlightbackground="yellow",highlightthickness=20,bd=20,relief="ridge")
f1.grid(sticky=W)
"""
# Heading
w2 = Label(root, font=("arial",13,"bold") , text="Disease Prediction System",width = 50 , height = 3 , fg="yellow", bg="black")
w2.grid(row=1)

f1=Frame(root,width=1363,height=400,bg="blue",highlightbackground="yellow",highlightthickness=20,bd=20,relief="ridge")
f1.grid(sticky=W)
